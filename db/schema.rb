...
ActiveRecord::Schema[7.1].define(version: 2026_06_01_120000) do
  ...
  create_table "article_feedback_votes", force: :cascade do |t|
    t.bigint "article_id", null: false
    t.string "vote", null: false
    t.string "visitor_fingerprint", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id", "visitor_fingerprint"], name: "index_article_feedback_votes_on_article_and_fingerprint", unique: true
  end
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.integer "feedback_up_count", default: 0, null: false
    t.integer "feedback_down_count", default: 0, null: false
  ...
  create_table "inboxes", id: :serial, force: :cascade do |t|
    ...
    t.boolean "email_subject_prefix_enabled", default: false, null: false
    t.string "conversation_display_id_prefix"
  ...
  create_table "portals", force: :cascade do |t|
    ...
    t.string "header_cta_link"
    t.string "header_cta_label"
    t.string "homepage_link2"
    t.string "homepage_link2_label"
  ...
  add_foreign_key "article_feedback_votes", "articles"
