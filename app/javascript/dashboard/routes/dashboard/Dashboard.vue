...
<template>
  <div
    class="flex flex-grow overflow-hidden text-n-slate-12 bg-[rgb(var(--sand-accent))]"
  >
    <NextSidebar
    ...
    <main
      class="flex flex-1 h-full w-full min-h-0 px-0 overflow-hidden bg-[rgb(var(--sand-accent))]"
    >
      <UpgradePage
