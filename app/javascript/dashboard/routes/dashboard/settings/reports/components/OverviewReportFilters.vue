...
<template>
  ...
  >
    ...
    <div class="flex items-center rounded-full border border-[rgba(var(--slate-12),0.06)] bg-white px-2 py-1">
      <span class="mx-2 text-sm whitespace-nowrap text-n-slate-10">
