      ...
      <template #control>
        ...
        >
          <Button
            ...
            class="!rounded-full !border !border-[rgba(var(--slate-12),0.06)] !bg-[rgba(var(--sage-accent),0.18)] !text-n-slate-12 max-w-[200px]"
        ...
        <Button
          ...
          class="!rounded-full !border !border-[rgba(var(--slate-12),0.06)] !bg-white !text-n-slate-12"
