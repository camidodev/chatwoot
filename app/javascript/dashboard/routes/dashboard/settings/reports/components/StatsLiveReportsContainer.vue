...
<template>
  <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.45fr)_minmax(18rem,0.8fr)]">
    <div
      class="w-full max-w-full conversation-metric"
    >
      <MetricCard
      ...
      >
        ...
        >
          <h3 class="text-[12px] font-medium text-n-slate-10">
            {{ name }}
          </h3>
          <p class="text-n-slate-12 text-[2rem] leading-[1.05] mb-0 mt-1 font-semibold tracking-[-0.03em]">
            {{ metric }}
          </p>
        </div>
      </MetricCard>
