...
<template>
  ...
  />
  <div
    class="relative flex-1 overflow-auto px-4 py-4 mt-5 rounded-[24px] border border-[rgba(var(--slate-12),0.06)] bg-white shadow-[0_10px_28px_rgba(15,23,42,0.035)]"
  >
    <Table :table="table" />
    <Transition
    ...
    >
      <div
        v-if="isLoading"
        class="absolute inset-0 flex justify-center pt-[12.5rem] bg-white/70 rounded-[24px] pointer-events-none"
      >
