...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Lume?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://Lume.dev/invoice.pdf'),
      getAttachment('file', 'https://Lume.dev/logs.txt'),
      getAttachment('file', 'https://Lume.dev/contacts.xls'),
      getAttachment('file', 'https://Lume.dev/customers.csv'),
      getAttachment('file', 'https://Lume.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://Lume.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://Lume.dev/all-files.tar'),
      getAttachment(
        'audio',
