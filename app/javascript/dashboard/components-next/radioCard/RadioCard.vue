...
<template>
  <div
    ...
    :class="[
      ...
      isActive ? 'outline-n-slate-8 bg-n-background' : 'outline-n-weak',
    ...
    <div class="flex flex-col gap-2 items-start">
      <div class="flex items-center justify-between w-full gap-3">
        ...
        <input
          ...
          :disabled="disabled"
          type="radio"
          class="h-4 w-4 border-n-slate-6 text-n-black focus:ring-n-slate-8 focus:ring-offset-0 flex-shrink-0"
          @change="handleChange"
        />
      </div>
