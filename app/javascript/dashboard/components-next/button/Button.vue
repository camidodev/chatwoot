...
const STYLE_CONFIG = {
  colors: {
    blue: {
      solid:
        'bg-n-black text-white hover:enabled:opacity-90 focus-visible:opacity-90 outline-transparent',
      faded:
        'bg-n-black/5 text-n-slate-12 hover:enabled:bg-n-black/10 focus-visible:bg-n-black/10 outline-transparent',
      outline:
        'text-n-slate-12 outline-n-weak hover:enabled:bg-n-black/5 focus-visible:bg-n-black/5',
      ghost:
