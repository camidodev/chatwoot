...
<template>
  <TeleportWithDirection to="body">
    <dialog
      ref="dialogRef"
      class="w-full transition-all duration-300 ease-in-out shadow-xl rounded-2xl border border-n-weak bg-n-surface-1"
      :class="[
        maxWidthClass,
        positionClass,
    ...
    >
      <OnClickOutside @trigger="handleClickOutside">
        <form
          ...
          class="flex flex-col w-full h-auto gap-6 p-7 overflow-visible text-start align-middle transition-all duration-300 ease-in-out transform bg-n-surface-1 shadow-none rounded-2xl"
