...
<template>
  <div class="relative flex flex-col gap-1">
    ...
    <div
      class="flex flex-col gap-2 px-3 pt-3 pb-3 transition-all duration-500 ease-in-out border rounded-xl bg-n-surface-1"
      :class="[
        customTextAreaWrapperClass,
        {
          'cursor-not-allowed opacity-50 !bg-n-surface-1 disabled:border-n-weak dark:disabled:border-n-weak':
            disabled,
          'border-n-slate-8 dark:border-n-slate-8': isFocused,
