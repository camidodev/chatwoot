...
<template>
  <div
    class="flex gap-4 items-center px-4 py-2.5 w-full rounded-xl divide-x transition-colors bg-n-surface-1 outline outline-1 outline-n-weak hover:outline-n-slate-6 focus-within:outline-n-slate-8 divide-n-weak"
  >
    <div
    ...
    >
      <label class="inline-flex gap-2 items-center text-base cursor-pointer">
        <input
          ...
          class="size-4 accent-n-black text-n-black"
