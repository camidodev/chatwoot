...
<template>
  <div
    class="flex flex-col flex-shrink-0 conversations-list-wrap bg-white rounded-[24px] border border-[rgba(var(--slate-12),0.07)] overflow-hidden shadow-[0_10px_30px_rgba(15,23,42,0.04)]"
    :class="[
      { hidden: !showConversationList },
      isOnExpandedLayout ? 'basis-full' : 'w-[360px] 2xl:w-[428px]',
    ]"
  >
    <slot />
    <ChatListHeader
    ...
    <div
      ...
      class="flex-1 min-h-0 overflow-y-auto conversations-list px-2 pb-2"
