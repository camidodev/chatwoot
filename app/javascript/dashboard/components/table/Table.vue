...
<template>
  <table class="w-full border-separate border-spacing-0" :class="{ 'table-fixed': fixed }">
    <thead class="sticky top-0 z-10 bg-white">
      ...
      >
        <th
          ...
          class="text-left py-3.5 px-5 font-medium text-sm text-n-slate-12 border-b border-[rgba(var(--slate-12),0.06)]"
          :class="headerClass"
    ...
    <tbody class="divide-y divide-[rgba(var(--slate-12),0.06)] bg-white">
