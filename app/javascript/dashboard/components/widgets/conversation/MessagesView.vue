...
<template>
  <div class="flex flex-col justify-between flex-grow h-full min-w-0 m-0">
    ...
    <MessageList
      ...
      class="conversation-panel flex-shrink flex-grow basis-px flex flex-col overflow-y-auto relative h-full m-0 pb-5 bg-white"
    ...
    >
      ...
      <template #unreadBadge>
        ...
        >
          <span
            class="rounded-full bg-n-slate-12 text-white text-xs font-medium my-2.5 mx-auto px-2.5 py-1.5"
          >
            {{ unreadMessageLabel }}
          </span>
        </li>
    ...
    <div
      class="flex relative flex-col border-t border-[rgba(var(--slate-12),0.06)]"
      :class="{
    ...
    >
      ...
      >
        <div
          class="flex py-2 pr-4 pl-5 rounded-full border border-[rgba(var(--slate-12),0.06)] bg-[rgba(var(--sage-accent),0.22)] dark:bg-n-solid-3 text-n-slate-11 text-xs font-semibold my-2.5 mx-auto"
        >
          {{ typingUserNames }}
          <img
