...
<template>
  <div
    class="relative flex items-start flex-grow-0 flex-shrink-0 w-auto max-w-full py-0 mx-0 my-1 rounded-[18px] border border-transparent cursor-pointer conversation transition-all duration-150 ease-out hover:bg-[rgba(var(--slate-12),0.025)] group"
    :class="{
      'active animate-card-select bg-[rgba(var(--sage-accent),0.28)] border-[rgba(var(--sage-accent),0.7)]': isActiveChat,
      'bg-[rgba(var(--sage-accent),0.16)]': selected,
      'px-0': compact,
      'px-3': !compact,
    }"
    @click="onCardClick"
  ...
  >
    ...
    <div
      class="px-0 py-3.5 border-b border-[rgba(var(--slate-12),0.05)] group-hover:border-transparent flex-1 min-w-0"
    >
      <div
      ...
      <h4
        class="conversation--user text-[14px] my-0 mx-2 capitalize pt-0.5 text-ellipsis overflow-hidden whitespace-nowrap flex-1 min-w-0 ltr:pr-16 rtl:pl-16 text-n-slate-12 tracking-[-0.01em]"
      ...
      <div
        class="absolute flex flex-col ltr:right-2 rtl:left-2"
        :class="showMetaSection ? 'top-8' : 'top-4'"
      >
        <span class="ml-auto font-normal leading-4 text-[11px] text-n-slate-10">
          <TimeAgo
        ...
        <span
          class="rounded-full text-xxs font-semibold h-4 leading-4 ltr:ml-auto rtl:mr-auto mt-1 min-w-[1.125rem] px-1.5 py-0 text-center text-white bg-n-slate-12"
