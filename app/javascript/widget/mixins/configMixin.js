export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.LumeWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.LumeWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.LumeWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.LumeWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.LumeWebChannel.preChatFormOptions || {};
